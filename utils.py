...
def generate_MidImage(iter, model, model1, model2, save_path, args):
    batch_size = args.batch_size
    datashape = model2.shape
    fixed_noise_128 = generateTensor(128).cuda()
    noisev = autograd.Variable(fixed_noise_128, volatile=True)
...
def generate_HDImage(iter, model, model1, model2, model3, model4, save_path, args):
    batch_size = args.batch_size
    datashape = model4.shape
    fixed_noise_128 = generateTensor(128).cuda()
    noisev = autograd.Variable(fixed_noise_128, volatile=True)
